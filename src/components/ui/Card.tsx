...
const Card = () => {
    ...
    const nextSlider = useCallback(() => setCurrentIndex((currentSlider) => currentSlider === data.length - 4 ? 0 : currentSlider + 1), [data.length]);
    ...
    return (
        <div className="text-center mt-0">
            ...
            <p className="text-5xl mt-4 font-bold">New And Most <br /> <span className="text-5xl font-bold">Popular Tours</span></p>
                        ...
                        >
                            ...
                            <div className="p-4 text-left">
                                ...
                                <div className="mt-36 ml-4">
                                    ...
                                    <h3 className="text-xl text-white hover:text-orange-500 font-semibold mb-2">{item.title}</h3>
